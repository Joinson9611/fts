<template>
  <div class="app-container">
    <div class="filter-container">
      <!-- 设备类型筛选 -->
      <el-select v-model="paramsGetRecord.device_type_id" placeholder="设备类型" filterable clearable style="width: 320px" class="filter-item" @change="deviceOptionsChange">
    ...
    <el-drawer
      :title="`记录详情-${historyInfo.project_name}`"
...
import { getHistoryFireList } from '@/api/history1_2s'
...
export default {
  ...
  methods: {
    ...
    getRecord() {
      ...
      getHistoryFireList(this.paramsGetRecord).then(res => {
